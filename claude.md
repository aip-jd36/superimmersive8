...
| **Reviewer Manual v0.1** | `06_Operations/reviewer-workbook/SI8-Reviewer-Manual-v0.1.md` | ACTIVE | 7-part internal manual: Philosophy (independence, evidence, uncertainty) → Framework (7 domains, 5 outcomes) → Workflow (Steps 0–6) → Domain Guidance (A/R/H/I/L/T/D, each with decision logic + evidence calibration) → Synthesis → Report Guidance → Governance. Jul 5, 2026. |
