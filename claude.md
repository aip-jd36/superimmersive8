...
| **PRD: Living Notebook** | `08_Platform/prds/PRD_LIVING_NOTEBOOK.md` | ACTIVE — v1.0 architecture frozen | Spec for the four-document Living Notebook (Platform Rights Matrix / SI8 Positions / Edge Cases / Pending Questions) — markdown-first, git-native, companion to (not replacement for) the Reviewer Manual. Includes "Default State: Uncertainty" governance principle and Freeze Notice. Jul 30, 2026, revised Aug 1-2, 2026. |
