...
| **Provenance Manifest Specification v0.1** | `06_Operations/provenance/SI8-Provenance-Manifest-Specification-v0.1.md` | ACTIVE | Canonical information architecture for SI8's provenance output: four disclosure zones (Embedded / Verification Page / Client Report / Private Archive), Zone A field definitions with rationale, Trust List independence framing, Numbers Protocol mapping, open questions. Send to Sofia alongside sample MP4. Jul 6, 2026. |
