...
| # | Item | Why It Matters |
|---|------|----------------|
| 1 | **Launch website v1 in 7 days** (not perfect) | Positioning, 2 paths, 1 lead form, 1 calendar link, "AI Rights safe lane" blurb. No more. |
...
| 7 | **Define your "No List"** | Safe lane boundaries. Prevents catastrophic time waste and risk. |
...
- [ ] Rights rider (explicit "safe lane" restrictions)
