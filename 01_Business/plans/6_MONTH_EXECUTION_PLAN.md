...
**Track 1: MyVideo / Taiwan (Distribution Credibility)**
- **Why:** Warm lead with Jamie Lin (Chairman, Taiwan Mobile) — closeable in 60-90 days
- **Strategic value:** "We program AI shorts for Taiwan Mobile" opens every door
- **Language:** Traditional Mandarin (with Jamie Lin relationship, English may work)
...
```
MyVideo Deal (Month 2-3)
        ↓
"We're on Taiwan Mobile's platform"
        ↓
...
Hire filmmakers for agency work
        ↓
Sign filmmakers for distribution
        ↓
More content for MyVideo
```

**Filmmaker Scouting: Global (English-Speaking)**
- **Why:** Best AI filmmakers are globally distributed, mostly English-speaking
- **Sources:** Twitter/X, Instagram, YouTube, Runway community, Curious Refuge alumni
- **Priority:** SEA-based filmmakers (can hire for agency work + sign for distribution)
- **Focus:** Quality and professionalism over geography

### Legal & Rights Infrastructure (Core Competency)

**Why this matters:**
SI8's positioning is "the trusted operator" who helps creators and brands navigate AI video **safely and legally**. This requires deep understanding of the evolving AI content legal landscape — not just contracts, but the underlying rights issues.

**The moat:** Most agencies and filmmakers are confused about AI rights. If SI8 becomes the expert who can answer "Is this legal? Is this brand-safe? What rights do we need?" — that's a defensible competitive advantage.

**Key areas to master:**

| Area | Why It Matters | Who Cares |
|------|----------------|-----------|
| **AI Copyright (by jurisdiction)** | Can AI-generated content be copyrighted? Who owns it? | Filmmakers, platforms |
| **Training Data Rights** | Was the AI model trained legally? Liability exposure? | Agencies, brands |
| **Likeness & Voice Rights** | Using real people's faces/voices in AI content | Brands, agencies |
| **Platform Policies** | What do streaming platforms require/prohibit for AI content? | Distribution deals |
...
- Rights checklist for productions
...
**10-15 hours/week = 40-60 hours/month = 240-360 hours over 6 months**
...
- Trying Singapore + Manila + KL + Bangkok + Jakarta simultaneously = getting none
- Pick ONE city first, prove the model, then expand

**Month 3+: Expand to other SEA markets** (only after Singapore playbook is working)
...
*These are the silent killers that break early-stage builds:*
...
**Legal Research (self-directed — iterate, don't perfect):**
- [ ] AI Copyright landscape: US Copyright Office guidance, recent cases
- [ ] Platform policies: Research YouTube, TikTok policies on AI content
- [ ] Create **Rights Playbook v0.1 (3 pages max)**:
  - Safe lane rules (what we will/won't do)
...
- [ ] Research via LinkedIn, agency directories, industry publications
- [ ] Identify decision makers (Creative Directors, Heads of Production, MDs)

**Time:** 8-10 hours
**Deliverable:** 100-agency Singapore target list
...
- [ ] Categorize: Tier 1 (reach first), Tier 2, Tier 3
- [ ] Note: Geographic distribution (SEA filmmakers = bonus for agency work)

**Time:** 6-8 hours
**Deliverable:** 30-filmmaker target list

### MyVideo / Taiwan Mobile (PRIORITY — Track 1)
- [ ] Draft proposal for Jamie Lin: Curated AI shorts pilot program
  - Concept: 5-10 AI shorts, 30-minute programming block
...
**Time:** 4-6 hours
**Deliverable:** Channel target list for future outreach
...
- [ ] Lower priority than Singapore — only if time permits

**Time:** 4-6 hours
**Goal:** 2-3 conversations

### Event List Building (CRITICAL — Start NOW)
- [ ] Begin building attendee list for Month 3 event
- [ ] Pre-sell "industry seats" even before final lineup confirmed
- [ ] Target: 20+ committed attendees before Month 3
- [ ] Make seats feel scarce ("limited to 25 industry executives")
...
**Time:** 8-10 hours
**Goal:** 5+ conversations, 1-2 soft commits

### MyVideo Follow-Up (PRIORITY — Track 1)
- [ ] Follow up with Jamie Lin on proposal
- [ ] If positive: Get LOI or written commitment for pilot
- [ ] If needs more: Offer to present in person, bring content samples
- [ ] If meeting scheduled: Prepare pitch deck, filmmaker showcase
- [ ] Identify internal champion (content head, programming director)
...
- [ ] Venue research: Hotels, co-working spaces, private dining in Taipei
- [ ] Theme: "AI Video for Brands: What Agencies Need to Know in 2026"
- [ ] Invite list: Mix of SEA + Taiwan agency contacts, plus local creatives
- [ ] Consider: Can MyVideo/Taiwan Mobile content head be a speaker?

**Time:** 6-8 hours
**Goal:** Date, venue, and format confirmed
...
|-------|--------|--------|--------|
| **Track 1: MyVideo** | Status | LOI or clear signal | |
...
- **MyVideo YES + SEA slow:** Lead with MyVideo credibility, adjust SEA messaging
- **MyVideo slow + SEA traction:** Focus on SEA, keep MyVideo warm
- **Both slow:** Reassess targeting and messaging

**Warning signs:**
- <10% response rate from SEA agencies = messaging problem
- Zero discovery calls = targeting or offer problem
- MyVideo going dark = need to re-engage through different channel
...
- [ ] Execute first event (target: 20-30 attendees)
- [ ] Attendee mix: 50% agency/brand execs, 50% AI creators/enthusiasts
- [ ] Format: Keynote/panel + AI film showcase + networking
- [ ] Your role: Host, moderator, primary expert
- [ ] Capture: Photos, testimonials, contact info
- [ ] Post-event: Follow-up emails, meeting requests

**Event goals:**
- 20+ attendees
- 3-5 follow-up meetings with agency execs
- Content for social proof
- 1+ potential sponsor conversation
...
**Time:** 4-6 hours
**Goal:** 1 channel moving toward commitment
...
**Time:** 4-6 hours
**Goal:** 1 distribution deal closed OR MyVideo pilot underway

### Sponsor Development
- [ ] Create sponsor deck for events
- [ ] Outreach to 5-10 potential sponsors (AI tool companies, agencies)
- [ ] Goal: 1-2 sponsors for Q3 events
...
**Time:** 2-3 hours
**Goal:** Rights process documented enough to repeat reliably
...
**On track for $5K/month by Month 6?**

---

## Month 5: June 2026 — Scale or Adjust
...
### Third Event (or Skip to Plan Q3)
- [ ] If momentum good: Third event, potentially larger format
- [ ] If events draining: Pause events, focus on 1:1 sales
- [ ] Decision: Are events converting to revenue? If not, cut.
...
**Time:** 3-4 hours
**Goal:** Legal expertise becomes explicit sales asset

### Month 5 Checkpoint

**Critical question:** Can you see a path to $5K/month?
...
## Month 6: July 2026 — Assessment + H2 Planning

**Theme:** "Honest assessment. Decide next phase."
**Hours:** 40-50 hours

### 6-Month Validation Assessment
...
- [ ] Set new milestones
- [ ] Budget for H2 based on actual revenue
- [ ] Decide: Accelerate, maintain, pivot, or pause
...
| June | 50-60 | Scale + event #3 |
| July | 40-50 | Assessment + planning |
| **Total** | **275-335** | ~11-13 hours/week average |

### Money

| Category | 6-Month Budget |
|----------|----------------|
| Legal (contracts, lawyer) | $2,500-4,000 |
| Events (3 events) | $3,000-6,000 |
| Website/tools | $200-500 |
| Marketing (LinkedIn, etc.) | $300-500 |
| Travel (if needed for SEA) | $1,000-2,000 |
...
**Week 1:** Outreach push (new contacts)
**Week 2:** Follow-up and nurture
**Week 3:** Event prep (if applicable) or deal close push
**Week 4:** Review metrics, adjust strategy, plan next month
...
## Appendix: Legal & Rights Roadmap

**Why this matters:** SI8's tagline is "the trusted operator at the intersection of AI creators, rights, and commercial deployment." Legal/rights expertise is a core competency and competitive moat — not just an admin task.

### 6-Month Legal Research Roadmap
...
**Copyright & Ownership:**
- Can AI-generated content be copyrighted in US? Taiwan? Singapore?
- Who owns the output: prompter, tool company, or no one?
- How do different AI tools (Runway, Midjourney, Sora) handle IP?

**Training Data & Liability:**
- What lawsuits are pending against AI video tools?
- What liability exposure do users of these tools have?
- How to assess "clean" vs "risky" AI tools?

**Likeness & Voice:**
- When can AI-generated faces be used commercially?
- What are the rules for voice cloning?
- Celebrity likeness vs. synthetic faces?

**Platform Requirements:**
- What do streaming platforms require for AI content disclosure?
- What content restrictions exist (violence, adult, political)?
- How do ad platforms (Meta, Google) treat AI content?

**Brand Safety:**
- What makes AI content "brand-safe"?
- What disclosures do brands need?
- How to document provenance and rights chain?

### Legal as Sales Asset
...
*This plan is a living document. Update monthly based on actual progress and learnings.*
