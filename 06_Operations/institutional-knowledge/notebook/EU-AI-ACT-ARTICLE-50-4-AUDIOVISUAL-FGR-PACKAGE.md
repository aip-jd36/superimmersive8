...
**Topic: `ai_content_transparency` (KnowledgeTopic) — PM-CONCURRED 2026-09-13, NOT YET FORMALLY ADOPTED.** Recommended 2026-09-13 in `governance-reviews/FGR_019_ADDENDUM_TOPIC_TAXONOMY_RECOMMENDATION_2026-09-13.md`, following the `KnowledgeTopic` engineering foundation now on `origin/main`; PM concurrence recorded the same day in `governance-reviews/FGR_019_ADDENDUM_TOPIC_TAXONOMY_PM_CONCURRENCE_2026-09-13.md`. `KnowledgeTopic` (not `GoalCategory`) is the correct field type for this claim — see §8, updated. This is a PM-concurred naming decision, not a production value or a formal Adoption decision: `KNOWLEDGE_ONLY_TOPICS` remains `[]` in code, `Lifecycle` below remains `Candidate`, and this field is not finalized in the production sense until a separate PM Adoption decision is made on the candidate claim itself.
