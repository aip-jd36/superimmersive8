...
## Post-verbatim addendum (added 2026-08-27, Pre-Adoption Wording Correction task — appended outside the verbatim boundary above per this folder's own discipline; the verbatim review body above is unmodified)

**Two pre-Adoption wording corrections applied to `MUSIC-SCENARIO-A-FGR-PACKAGE.md`**, identified by the FGR_006 integration review (§K "Evidence / wording challenge" and §F "Combined-package FGR format assessment") as non-substantive documentation defects, not governance decisions requiring a new FGR:

1. **A2** — "remains valid permanently, even if the subscription is later cancelled" narrowed to "remains licensed even if the subscription later ends." The cited Envato evidence ("remain licensed even if your subscription ends") states indefinite continuation but never uses "permanently" — the prior wording was an interpretive gloss stronger than the source. No change to evidence, provider_scope, dependencies, Lifecycle, or this review's own ACCEPT disposition.
2. **A-1** — the stale, never-valid internal cross-reference "(subject to §D2 below for agency/broadcaster/large-company cases)" (no "D2" heading exists in the package; the Enterprise-threshold content is section C's own A-7a, not section D) replaced with "subject to Artlist's separate Enterprise/Max Business plan requirement for agencies, broadcasters, and larger companies (see `CLAIM-MUSIC-ARTLIST-ENTERPRISE-THRESHOLD-001-v1`)" — a stable claim-ID cross-reference expressing the same substantive qualification without a document-local section pointer. Does not merge A-1 with A-7a; both remain separately governed, separately Adopted-or-not. No change to evidence, provider_scope, dependencies, Lifecycle, or this review's own ACCEPT disposition.

Neither correction changes this review's substantive conclusions (§4, §9) — both remain ACCEPT / ACCEPT WITH NARROWING exactly as originally reviewed. This addendum does not reopen, re-score, or re-adjudicate any candidate.

**Self-contained exact wording, all 10 propositions proposed for Adoption** (added per the integration review's §F traceability finding — this review previously required cross-referencing `MUSIC-SCENARIO-A-FGR-PACKAGE.md` for exact text; that dependency is now closed for the 10 accepted/narrowed candidates by inlining final wording here, mechanically, with no change to any disposition, provider_scope, evidence, dependency, Lifecycle, or CRC-eligibility recommendation already recorded in the verbatim review above):

1. **A1** — `CLAIM-MUSIC-ENVATO-SYNC-001-v1`, `['envato-elements']`: "Under Envato Elements' standard subscription, music items are licensed for use synchronized with other media (e.g. as part of a video), and may not be resold or redistributed as standalone audio files; the standard license excludes 'Broadcast' use specifically."
2. **A2** — `CLAIM-MUSIC-ENVATO-CANCELLATION-001-v1`, `['envato-elements']` (corrected, see above): "Per Envato Elements' own stated policy, a music license for a project completed and published while the subscription was active remains licensed even if the subscription later ends; new projects/uses after cancellation are not covered."
3. **EP1** — `CLAIM-MUSIC-EPIDEMIC-TIER-ADVERTISING-001-v1`, `['epidemic-sound']`: "Epidemic Sound's Single-Track Private Tier license excludes use in advertisements and other paid-media productions (including online pre/mid/post-roll placements); the separate Commercial Tier license does not carry this same exclusion (it excludes only 'TV ads'/broadcast-type content specifically), and separately grants a right to monetize via third-party ads displayed on the subscriber's own published Productions."
4. **A-1** — `CLAIM-MUSIC-ARTLIST-SOCIAL-VS-PRO-001-v1`, `['artlist']` (corrected, see above): "Artlist's Social license is exclusively for personal content creators (hobbyists, vloggers, independent creators) and does not cover projects made for clients or brands, paid/promoted videos, or broadcast use; the Pro/Business license is for professional creators, covers client and brand work, paid/promoted videos, and commercials/advertisements, and permits broadcasting, subject to Artlist's separate Enterprise/Max Business plan requirement for agencies, broadcasters, and larger companies (see `CLAIM-MUSIC-ARTLIST-ENTERPRISE-THRESHOLD-001-v1`)."
5. **A-2** — `CLAIM-MUSIC-ARTLIST-CLIENT-LICENSE-RETENTION-001-v1`, `['artlist']`: "Under Artlist's Pro/Business license, a Project incorporating a licensed Asset may be transferred to a client (or any other party) for their use, but the underlying Asset license is held by the subscriber only, not transferred to the client — the subscriber must ensure any client/collaborator complies with the license."
6. **A-3** — `CLAIM-MUSIC-ARTLIST-PROJECT-LICENSE-DURATION-001-v1`, `['artlist']`: "A Project created and published while an Artlist subscription is active remains licensed (including for continued monetization) indefinitely, even after the subscription is cancelled; downloaded Assets may not be used in new projects once the subscription has expired."
7. **A-4** — `CLAIM-MUSIC-ARTLIST-STANDALONE-EXPLOITATION-001-v1`, `['artlist']`: "Artlist Assets may only be used as integrated elements within a broader Project, and may not be copied, distributed, sold, shared, or otherwise exploited as standalone content (e.g. the music track on its own)."
8. **A-5** — `CLAIM-MUSIC-ARTLIST-AI-TRAINING-EXCLUSION-001-v1`, `['artlist']`: "Artlist Assets may not be used to create derivative works such as remixes or covers, or be included in datasets for machine learning, AI training, or the development/improvement of AI technologies."
9. **A-6** — `CLAIM-MUSIC-ARTLIST-PRO-ROYALTIES-001-v1`, `['artlist']`: "Artlist's public-performance/broadcast permission does not itself cover payment of royalties to Performance Rights Organizations (PROs) or other collecting societies; if a Project is reproduced or used for broadcast/public performance, the subscriber (or their client) may receive requests for mechanical-reproduction and/or public-performance royalty payments, and is responsible for paying them (or ensuring the relevant broadcaster/platform does)."
10. **A-7a** — `CLAIM-MUSIC-ARTLIST-ENTERPRISE-THRESHOLD-001-v1` (narrowed by this review, §4): "Artlist requires a Max Business plan or a customized Enterprise Agreement if the licensee works for an agency, a broadcaster, or a company/legal entity (including an aggregated group of companies) with more than 50 employees; this requirement does not apply to subscription plans consisting solely of AI Services."
