...
Archived 2026-08-18. Reconstructed verbatim from this session's own conversation transcript (the immediately preceding turn's own Formal CRC-Publication Review response) — not from memory, not from the condensed summary already in `GOVERNED-CLAIMS.md`, not from the FGR.
