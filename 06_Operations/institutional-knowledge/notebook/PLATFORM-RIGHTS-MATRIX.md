...
| Field | Value |
|---|---|
| Plan Tier | — (not yet differentiated) |
| Source Wording / Confirmed Fact | Unconfirmed — not yet independently verified against Runway's current ToS |
| SI8 Interpretation | — (pending verification of source fact) |
| Training Data Disclosure | Unconfirmed |
| Known Restrictions | Unconfirmed |
| Last Verified | Never |
| Source | — |
| Status | **Unconfirmed** |
...
|---|---|
| Plan Tier | — (not yet differentiated) |
| Source Wording / Confirmed Fact | Unconfirmed — not yet independently verified against Kling's current ToS |
| SI8 Interpretation | — (pending verification of source fact) |
| Training Data Disclosure | Unconfirmed |
| Known Restrictions | Unconfirmed |
| Last Verified | Never |
...
|---|---|
| Plan Tier | — (not yet differentiated) |
| Source Wording / Confirmed Fact | Unconfirmed — not yet independently verified against Pika's current ToS |
| SI8 Interpretation | — (pending verification of source fact) |
| Training Data Disclosure | Unconfirmed |
| Known Restrictions | Unconfirmed |
| Last Verified | Never |
...
|---|---|
| Plan Tier | — (not yet differentiated) |
| Source Wording / Confirmed Fact | Unconfirmed — not yet independently verified against Veo's current ToS |
| SI8 Interpretation | — (pending verification of source fact) |
| Training Data Disclosure | Unconfirmed |
| Known Restrictions | Unconfirmed |
| Last Verified | Never |
...
|---|---|
| Plan Tier | — |
| Source Wording / Confirmed Fact | Adobe publicly markets an IP-indemnification commitment tied to Firefly-generated commercial content, used in Firefly's own "commercially safe" positioning. **Exact scope, eligibility, and current terms of that indemnification have not been independently reviewed by SI8** — this row currently reflects general market awareness, not a primary-source read. |
| SI8 Interpretation | This is the basis of SI8's competitive contrast ("Adobe verifies Firefly only. We verify Runway/Kling/Pika — the tools legal teams are blocking"). That contrast currently rests on an unverified premise about what Adobe's indemnification actually covers — treat as a claim to confirm, not a fact to repeat under scrutiny (e.g. in a proposal a prospect's legal team might push back on) until reverified. |
| Training Data Disclosure | Unconfirmed in detail — understood generally to be Adobe Stock-trained, which is the basis of Adobe's indemnification claim |
| Known Restrictions | Unconfirmed |
