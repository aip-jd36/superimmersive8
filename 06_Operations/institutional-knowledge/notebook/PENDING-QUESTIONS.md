...
### PQ-007 — Does SI8's assessment methodology need a jurisdiction-specific compliance layer for public-sector/government clients (e.g., Taiwan's mainland-capital tool screening)?

**Status:** Open
**Raised:** 2026-08-13, from Alice Feng's (Anchor Film) panel open-mic remarks, AI Wave 微醺夜 (`03_Sales/transcripts/numbers-gumgum-panel-073026-full-transcript.txt`; see also `03_Sales/call-notes/CALL-2026-07-30-B164-Alice-Feng-Anchor-Film.md`, "Panel Open-Mic Remarks" section)
**Why it matters:** Alice disclosed that Taiwan government/public-sector clients screen AI tools for whether they are "陸資" (mainland-China-linked capital) before a vendor can even propose using them — a restriction layered on top of, and entirely separate from, IP/rights compliance, and one she was explicit does not apply to Anchor's US-facing work. SI8's current assessment methodology (Reviewer Manual v0.2, 7 domains A/R/H/I/L/T/D) has no domain addressing tool-sourcing/geopolitical-capital restrictions — it evaluates commercial-rights risk, not procurement-eligibility risk. It's not yet decided whether this is in scope for SI8 at all (arguably a client's own procurement-compliance question, not a commercial-assurance question), out of scope entirely, or worth a narrow disclosure note if it ever surfaces in a real Taiwan public-sector-adjacent engagement.
**Promotion path:** Resolves if/when a real Taiwan public-sector-adjacent engagement surfaces this fact pattern and forces a concrete scoping decision, or if a deliberate review decides it's out of scope on its own (in which case: Closed, not Promoted).
