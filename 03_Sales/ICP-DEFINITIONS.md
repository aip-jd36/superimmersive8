...
## ICP 1: Agency Creative / Production at Finserv-Exposed Clients
...
| Lead | B-ID | Signal |
|------|------|--------|
| Matthew Sergison-Main | B088 | "Yes I am being asked this 100%" — Senior Production Specialist, OLIVER/Brandtech, serving enterprise brands |
| Ibrahim Badi | B087 | "Yes especially in regulated sectors" — documents AI models, commercial licensing, editing workflow, IP ownership |
| Ahmed Samy Amin | B103 | "I've been navigating this a lot lately in video production for financial and brand clients" — Dubai, GTCFX |
| Ramez Tabshi | B100 | "IP provenance and training data transparency is absolutely escalating with clients" — Dubai finserv market |
| Marc De Guzman | B027 | UnaFinancial Creative Head — confirms finserv as demand source (buyer side, not agency) |
