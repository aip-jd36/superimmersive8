...
**Last updated:** Jul 1, 2026 (P001 Sofia Yan / Numbers Protocol — in-person Taipei call completed; C2PA Trust List finding: old Capture upload-based signing NOT on Trust List; ERC-7053 on-chain still valid; API access offered; call notes filed)
