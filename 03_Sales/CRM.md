...
**Last updated:** Jun 25, 2026 (P001 Sofia Yan / Numbers Protocol added — Capture co-founder CGO, Taipei, inbound reply to JD outreach; meeting being scheduled; MP4 confirmed, custom assertions confirmed, Art. 50 framing aligned)
...
| P001 | Sofia Yan | Numbers Protocol (Capture) | partner | Meeting Scheduling | 2026-06-25 | Co-founder & CGO, Numbers Protocol. Taipei-based. Inbound reply to JD outreach re: Capture integration for SI8 v4.1. Confirmed: MP4/MOV/WebM video signing supported; C2PA custom assertions supported; ERC-7053 on-chain included; workflow (sign final delivered MP4 before client handoff) is aligned. Art. 50 framing: careful — prefers "supports Art. 50-style transparency" not "satisfies Art. 50 obligation." JD replied same day proposing Taipei coffee — Fri afternoon or next week. | Confirm meeting time; bring Chain of Title schema; agenda: schema mapping, where signing happens in workflow, verification URL, pilot pricing/terms | 2026-06-27 | HIGH | waiting |
