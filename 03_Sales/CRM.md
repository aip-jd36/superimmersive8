...
| B101 | Anas Bakal | Monoud Trading | buyer | Call Scheduled | 2026-06-22 | Detailed 3-point reply to JD Jun 22: (1) licensing AI tools for specific commercial use; (2) maintaining prompt logs/generation settings for provenance; (3) labeling/digital signature requirements from platform regulations. Title confirmed: AI Creative Director | Luxury Brand Experience Architect. Self-scheduled Calendly call (date TBD). Note: alias error — original Lilly convo signed as Vanessa. Email: Anasbakal1994@gmail.com · Phone: +971552787780 | Prepare for call — gate Qs: is the documentation requirement written/contractual or conversational? volume of AI campaigns per month? direct brand relationships or through agency? | — | HIGH | calendly self-scheduled |
...
| P001 | Sofia Yan | Numbers Protocol (Capture) | partner | Evaluating | 2026-07-01 | In-person Taipei meeting Jul 1. Numbers confirmed infra-only; SI8's evidence package concept resonated ("SOC2 audit"). C2PA Trust List status for edited MP4 via Capture API = UNCONFIRMED. Follow-up email sent same day: technical provenance vs. commercial clearance framing, requested API docs + sandbox credentials + pricing + MP4 sample code, asked Trust List Q directly ("would signed file appear as Trust List-recognized signer in Adobe Content Authenticity, or embedded C2PA + ERC-7053 only?"). Shared meeting recording. Call notes: `03_Sales/call-notes/CALL-2026-07-01-P001-Sofia-Yan-Numbers-Protocol.md` | Await Sofia reply on Trust List Q + API credentials. Once received: sign test MP4, document Adobe viewer output exactly. | 2026-07-07 | HIGH | waiting — api credentials + trust list answer |
| P002 | Sherry Chung | Numbers Protocol | partner | Met In-Person | 2026-07-30 | Met at AI Wave 微醺夜 panel (Numbers/GumGum). Card says Business Developer (@sherry_numbers, sherry@numbersprotocol.io); JD believes she may also be a co-founder and technical lead — unconfirmed, worth clarifying directly rather than assuming. JD spoke with her after the panel about partnering on more technical features (C2PA/Capture integration side, distinct from the commercial-partnership conversation with Sofia) — no audio recording of this conversation exists. | Log full notes from the unrecorded post-panel technical-partnership conversation once JD writes them up; clarify her actual role/title | — | MEDIUM | to log |
