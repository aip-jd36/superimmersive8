...
| B002 | Theodor (Teddy) Sandu | MullenLowe Singapore (IPG) | buyer | Warm Lead | 2026-06-16 | Lilly handoff 5/24; connection accepted Jun 16; JD sent holdco gate Q Jun 16 [JD personal]. Replied same day: "Hi JD, they are asking for both. Cheers" — T1 signal, both disclosure + Chain of Title. Creative Director, Singapore holdco. | Send Part 2 gate: "What do you typically send them for the Chain of Title piece — and does it satisfy the legal team or do they come back asking for more?" | 2026-06-18 | HIGH | waiting |
...
| B130 | Ivan Petruzzelli | State Street Investment Management | buyer | Warm Lead | 2026-06-17 | "Yes we are" — confirmed State Street moving toward structured documentation; Jun 16 format probe sent. Jun 17 reply: "Yes we require a single, structured campaign brief that combines a short human summary with a machine-readable payload (spreadsheet or JSON). This ensures clarity, repeatability, and auditability across AI-driven workflows." Ambiguous — could be IP provenance documentation or campaign workflow data. [Ivy] | JD to draft reply — probe whether brief is specifically about AI content IP/tools/ownership or broader campaign workflow data. Do not send until JD decides on angle. | 2026-06-17 | HIGH | draft needed |
...
| B160 | William Finkel | Hello Sunshine | buyer | Replied-Warm | 2026-06-17 | EVP Business & Legal Affairs, Hello Sunshine. NYC. Replied to BLA US campaign — described ICP 3 cascade mechanism verbatim: "compliance requirement will be passed down the line to agency and then production co... legal should be the last level of confirmation and responsibility." No current AI productions at HS. Said "happy to help however I can." Strongest ICP 3 signal in pipeline. [JD alias, SI8_RV_R4LI_LegalA_BLA_US_0626A_JC] | QUEUED Jun 18 — affirm his cascade description + COT format sanity check ask: "Would you be willing to look at a sample and tell me if it's what you'd want an agency to hand you?" Research frame, not pitch. | 2026-06-18 | HIGH | queued |
