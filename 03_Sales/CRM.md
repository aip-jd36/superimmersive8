...
| B027 | Marc Danielle De Guzman | UnaFinancial | buyer | Warm Lead | 2026-06-16 | Lilly campaign reply: "would be great to connect and hear more — please have JD reach out directly." Connection accepted Jun 16; JD sent gate question: "has a compliance team or client at UnaFinancial asked for something beyond which tools you used? what did you send — did that satisfy them or did they come back with more?" Metro Manila. [Lilly/JD, SI8_Blocks AI Campaign] | Await reply — gap story (wasn't satisfied) = move to call; T2 reply (no specific ask yet) = probe timing | 2026-06-19 | HIGH | waiting |
...
| B100 | Ramez Tabshi | — | buyer | Call Requested | 2026-06-16 | Replied: on holiday, May 28/29 off table; "IP provenance and training data transparency is absolutely escalating with clients" (strong unprompted validation); Jun 1 fell through. Re-engagement sent Jun 16: "hope the break was good — still keen to connect? let me know a couple slots" [JD personal] | Await reply — book call on response; send Zoom invite | 2026-06-19 | HIGH | waiting |
