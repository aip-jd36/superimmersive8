...
**Last updated:** Jun 10, 2026 (B148–B155 added from signal scan; B027 + B094 upgraded; see also B145 Daniele Zennaro B2B2B confirmation)
...
| B027 | Marc Danielle De Guzman | UnaFinancial | buyer | Followed Up — No Reply | 2026-05-26 | Lilly campaign reply: "would be great to connect and hear more — please have JD reach out directly." JD sent connection request 5/26 + follow-up. No response. Original reply was HIGH intent — explicit request for JD intro, named follow-through. Metro Manila. [Lilly/JD, SI8_Blocks AI Campaign] | Re-engage: reference his original intent to continue; clearance-language framing; send sample | 2026-06-17 | HIGH | pending |
...
| B125 | Tim Deussen | XRBB - Extended Reality Berlin-Brandenburg | partner/advisor | Advisory | 2026-06-11 | Jun 6 reply: corrected Art. 50 (labeling/disclosure, not Chain of Title); validated SI8 for IP compliance ("in that domain your product makes sense"); flagged gap: "still disconnected from the technical process"; shared official EU Art. 50 draft guidelines link. Jun 8: partner/advisor ask sent — 20-min call with JD [Angel]. Jun 11 analysis: NOT a buyer — builds compliance technology for EU working groups; upstream of beachhead. Art. 50 correction impacts all EU Act urgency hooks in outreach (must reframe to "IP compliance / brand legal"). Pre/post production critique validates Test D. | Schedule call from Jun 22 — advisory framing: product framing validation + EU Act accuracy review. NOT a sales call. | 2026-06-22 | HIGH | schedule call |
...
| B143 | Simon Helm | — | buyer | Call Requested | 2026-06-08 | EU AI Act msg#2 reply (Jun 2): "feels very relevant, advising clients already. Can we chat?" Ivy replied Jun 8: asked for Tue/Wed/Thu 9:30–10am UK availability [Ivy, SI8_EU AI Act, England] | Await his slot reply; send Zoom invite; JD leads call | 2026-06-12 | HIGH | waiting |
...
| B152 | Jian Yi Lay | VaynerMedia APAC | buyer | Warm Lead | 2026-05-29 | "Before starting work, AI usage and which platform must be cleared by both agency and clients legal team first." Formal pre-project legal gate already in place. Group Creative Director, Singapore. Holdco = compliance structure. [Lilly/JD, SI8_Legal Friction Singapore] | BLOCKED — JD connection request not yet accepted; cannot message. When accepted: probe what formal pre-project process looks like; send sample; position SI8 as deliverable documentation layer for what they already clear | 2026-06-17 | HIGH | waiting |
| B153 | Ali Loveday-Herzinger | YouTube | buyer | Warm Lead | 2026-05-29 | Executive Producer title at YouTube Singapore. Warm signal — msg 2 (pitch) sent. No response documented after msg 2. EP profile = Clearance-Pro ICP. [SI8_Legal Friction Singapore] | BLOCKED — JD connection request not yet accepted; cannot message. When accepted: send sample; Clearance-Pro EP framing ("same concept as music sync clearance report, but for the AI layer") | 2026-06-17 | MEDIUM | waiting |
