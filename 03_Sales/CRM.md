...
**Last updated:** May 29, 2026 (B121 Gabriel, B138 Tunç, B068 Marchel, B076 Dagny, B040 Hasan, B056 Michael, B127 Ulrike, B128 Christopher → all Followed Up; B105/B108/B133 voided — Lilly inaccessible)
...
| B087 | Ibrahim Badi | IKM Marketing | buyer | Warm Lead | 2026-05-29 | Mapped his process to our 9 questions: covers 1,2,6,9 (tools/versions/prompts); 3-5 clean (no stock, no real people). "Creator Record makes sense as next step when I move into client commercial work — won't be long." Asked: "What types of brands are typically coming to you for clearance?" — strong product validation + future intent signal [Ivy] | Reply: answer brand Q + send COMP-B2 code now (no expiry) — no call, no manager | — | MEDIUM | pending |
| B088 | Matthew Sergison-Main | OLIVER / The Brandtech Group | buyer | Followed Up | 2026-05-28 | "Yes I am being asked this 100%" — Senior Video Production Specialist, Winchester (Brandtech holdco) [Ivy, SI8_Legal Friction]; May 1: legal team vs procurement Q + HPI Check logline; May 28: clearance report deliverables listed inline (tool attribution, training data, likeness, IP, audio, territory, risk rating, final verdict) + "does this cover what OLIVER's clients are asking for?" | Await reply — if yes → call; if gap identified → product feedback gold | — | HIGH | waiting |
...
| B125 | Tim Deussen | XRBB - Extended Reality Berlin-Brandenburg | buyer | Followed Up | 2026-05-28 | Expert reviewer message sent — 9 questions embedded + "Is this close to what you think will be necessary for the upcoming AI Act?" Builds compliance tech + EU working group participant. May be partner/validator rather than direct buyer. [Angel] | Await reply — if substantive, offer 20-min call (not free code) | — | MEDIUM | waiting |
...
| B130 | Ivan Petruzzelli | State Street Investment Management | buyer | Followed Up | 2026-05-29 12:45 TPE | "Yes we are" — confirmed State Street moving toward structured documentation; May 29: "building internally or looking at what's out there?" + 9 questions + two-tier breakdown inline + free code offer [Ivy] | Await reply — if engages, offer 15-min call (no manager framing) | — | HIGH | waiting |
