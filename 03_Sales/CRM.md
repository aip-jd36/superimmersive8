...
**Last updated:** Sep 1, 2026 (B167 Patrick Lee/Fanverse — new lead added; JD sent re-engagement email referencing his StartSphere Taipei speaking panel this week, introducing SI8 + CRC, proposing coffee/Zoom). Previously: Aug 21/24, 2026 (B164 Alice Feng/Anchor Film — Aug 21 follow-up call logged: creation-record prototype status, new grant mechanics, CRC live-demo, Sept 3-4 event invite + intros offered; see `crm/anchor-film.md` and call notes for full detail). Previously: Aug 13, 2026 (B164 Alice Feng/Anchor Film — panel open-mic remarks logged in full, from a newly-transcribed complete recording of the same event; see call notes for content and flagged follow-up candidates). Previously: Aug 8, 2026 (B163 Jeffrey Chen/Kneron — follow-up email sent referencing his GumGum Q&A question, awaiting reply; B166 Damien Barron-Tan/Carbon — pre-call warm-up email sent, new name Matthew Crescenzo surfaced as a CC, identity unconfirmed). Previously: Aug 5, 2026 (B166 Damien Barron-Tan/Carbon Moves — new inbound Calendly booking, Aug 13 call, context/relationship unconfirmed). Previously: Aug 2, 2026 (B164 Alice Feng/Anchor Film — noted Living Notebook incorporation: source evidence for POS-001 + POS-005, grant-engagement conflict question logged as PQ-006). Previously: Jul 31, 2026 (4 new contacts from AI Wave 微醺夜 panel Jul 30: B163 Jeffrey Chen/Kneron — HIGH, real follow-up needed; B164 Alice Feng/Anchor Film; B165 Aaron Chen/Harbor Angel — new `investor` type; P002 Sherry Chung/Numbers Protocol)
...
| B002 | Theodor (Teddy) Sandu | MullenLowe Singapore (IPG) | buyer | Warm Lead | 2026-06-29 | Lilly handoff 5/24; connection accepted Jun 16; JD sent holdco gate Q Jun 16 [JD personal]. Replied same day: "Hi JD, they are asking for both. Cheers" — T1 signal, both disclosure + Chain of Title. Creative Director, Singapore holdco. Jun 29: RESEARCH PROBE drafted (JD personal): "When that comes up, what's the first thing legal actually asks to see?" Evidence-priority Q — clarifies what matters most to holdco legal teams. | Await reply | 2026-07-06 | HIGH | waiting |
...
| B011 | Hugo Barbera | HumAIn | buyer | Followed Up | 2026-05-08 13:35 TPE | Second nudge: offered sample Chain of Title as lower-friction alternative to call [Ivy] | **Graduated to `crm/hugo-barbera.md` 2026-09-01.** Commercial Readiness discovery follow-up drafted, not sent (Priority 1). | 2026-09-03 | HIGH | graduated |
...
| B027 | Marc Danielle De Guzman | UnaFinancial | network | Closed — Prospective Hire | 2026-06-17 | Gate Q reply Jun 16 (solid T1 signal but turned out to be job-seeker). Replied "I'm into Creatives and social media Marketing right now." JD closed: "I'll keep you in mind as the team grows. You clearly understand the space well, which is rare. Happy to stay connected." [Lilly/JD, SI8_Blocks AI Campaign] | No action needed — reconnect if hiring for creative/social media role | — | LOW | done |
...
| B045 | Mike Harris | Seenit | buyer | Call Booked | 2026-05-17 TPE | "Thanks, - booked!" — confirmed via Calendly [Ivy] | **Graduated to `crm/seenit.md` 2026-08-15** — flagged there as stale, needs a status check | — | HIGH | graduated |
...
| B048 | Piotr Nierobisz | Munchingsquare | buyer | Followed Up | 2026-05-08 13:37 TPE | Second nudge: checked if he reviewed sample; re-offered JD call [Vanessa] | **Graduated to `crm/piotr-nierobisz.md` 2026-09-01.** Commercial Readiness discovery follow-up drafted, not sent (Priority 2 per this batch, though CRM's own HIGH urgency suggests earlier attention). | 2026-09-08 | HIGH | graduated |
...
| B079 | Tunc Akyuz | Big Media & Technology | buyer | Followed Up | 2026-06-29 | "hasn't been asked yet, but a contract is being signed stating that I am responsible for the IP of all content" — Production Director, London [Ivy, SI8_Legal Friction England 0426B]; May 1: reply sent: does he have documentation to back up the IP guarantee, or verbal only? + Logline-UK-v1. Jun 29: RESEARCH PROBE drafted (Ivy): "Since you're personally responsible for the IP side, what's usually the hardest thing to prove if someone asks questions afterward?" Documentation-gap Q — identifies biggest evidence pain point. | Await reply | 2026-07-06 | MEDIUM | waiting |
...
| B087 | Ibrahim Badi | IKM Marketing | buyer | Warm Lead | 2026-06-29 | Answered brand vertical Q (finserv/pharma/holdco); explained B2B2B pattern (requirement starts at brand legal, filters to agency); sent free COMP-B2 code with "no rush, no expiry" framing [Ivy]. Jun 29: DESIGN PARTNER question drafted (Ivy): "Looking back at the last AI project you documented, was there anything you wished you'd captured as the work was happening rather than reconstructed afterward?" Evidence-gap Q — direct input for Creator Record field design. | **Graduated to `crm/ibrahim-badi.md` 2026-09-01.** Commercial Readiness discovery follow-up drafted, not sent (Priority 1); the Jun 29 evidence-gap Q above remains a separate open thread. | 2026-09-03 | MEDIUM | graduated |
| B088 | Matthew Sergison-Main | OLIVER / The Brandtech Group | buyer | Followed Up | 2026-06-29 | Break-up style follow-up Jun 8: "won't send more unless you reply" + B2B2B probe + deliverables format check [Ivy]. Jun 29: CONVERT message drafted — JD direct (Ivy thread hit break-up wall): "We spent the last month narrowing this down significantly, specifically based on conversations with embedded agency teams like OLIVER. We've landed somewhere quite specific and I'd love to show you before we go any wider. Would you have 20 minutes next week?" [JD personal LinkedIn] | **Graduated to `crm/matthew-sergison-main.md` 2026-09-01.** Commercial Readiness discovery follow-up drafted, not sent (Priority 1, relationship-maintenance framing) — confirm whether the Jun 29 JD-personal CONVERT message above got a reply before sending, since the Ivy thread already hit a break-up point once. | 2026-09-03 | HIGH | graduated |
...
| B094 | Justin Lufair Brown | Amazon | buyer | Followed Up | 2026-06-10 | "Contract language has tightened significantly — likeness rights, training data provenance, indemnification. SAG-AFTRA AI clauses pulled this forward. Happy to go deeper if useful." Creative Producer AI Video Production, LA. Jun 10: Vanessa sent sample + "do you think this is something people can use right now?" — wrong move, should have booked call. [Vanessa, SI8_Legal Friction LA 0426A] | Send Jun 17 [Vanessa]: "Still open to that deeper conversation you mentioned — would a 20-minute call this week or next work?" | 2026-06-17 | HIGH | waiting |
...
| B100 | Ramez Tabshi | — | buyer | Warm Lead | 2026-07-01 | **T1 CONFIRMED + PRODUCT FIT CONFIRMED.** "IP provenance and training data transparency is absolutely escalating with clients." Clients = enterprise, finserv, healthcare, public sector. Currently sends technical PDF (tools, data handling, security) — partially satisfies; follow-ups come. Jun 26 probe reply: "once their legal teams get involved, conversation immediately shifts to IP ownership and copyright risks… they want certainty outputs are cleared for commercial use and no liabilities re: likeness or model training data. That IP and commercial licensing document is exactly what they are looking for." Gap = exact SI8 product fit. [JD personal email Q&A] Jul 1: WAVE 1 LANGUAGE TEST sent (JD personal email) — "If you saw 'independent commercial clearance for AI-generated media,' would you immediately understand what we mean? Or would you use different language?" Testing whether "commercial clearance" is the right category term. | **Graduated to `crm/ramez-tabshi.md` 2026-09-01.** Commercial Readiness discovery follow-up drafted, not sent (Priority 1); the Jul 1 language-test above remains a separate, still-open thread. | 2026-09-03 | HIGH | graduated |
| B101 | Anas Bakal | Monoud Trading | buyer | Call Scheduled | 2026-06-22 | Detailed 3-point reply to JD Jun 22: (1) licensing AI tools for specific commercial use; (2) maintaining prompt logs/generation settings for provenance; (3) labeling/digital signature requirements from platform regulations. Title confirmed: AI Creative Director | Luxury Brand Experience Architect. Self-scheduled Calendly call (date TBD). Note: alias error — original Lilly convo signed as Vanessa. Email: Anasbakal1994@gmail.com · Phone: +971552787780 | **Graduated to `crm/monoud-trading.md` 2026-08-15** — call date still unconfirmed there too | — | HIGH | graduated |
...
| B103 | Ahmed Samy Amin | GTCFX | buyer | Followed Up | 2026-05-27 | Connected 5/26; replied "Would love to compare notes — what's the context you're seeing it come up in most?" [via Lilly]. JD sent pain probe + survey ask 5/27 — missed his actual question; no reply since. [JD personal / Lilly, Legal Friction Dubai] | Send Jun 17 [JD personal]: answer his context Q (finserv/regulated clients/Dubai), invite compare-notes call. Draft: "Circling back to your question — clearest context is finserv/regulated-sector clients. Their legal teams have compliance infrastructure that AI video just added to. Dubai has been particularly active. Would a quick compare-notes call work? Curious what you've been navigating on the financial and brand client side." | 2026-06-17 | HIGH | waiting |
| B104 | Ashraf Selo | MultiBank Group | buyer | Followed Up | 2026-06-29 | "Becoming standard with bigger campaigns" [Lilly]; connection accepted Jun 16; JD sent formal vs. informal probe Jun 16 [JD personal]; Phone: +971 55 344 1707. Jun 29: RESEARCH PROBE drafted (JD personal): "When documentation comes up with bigger campaigns, what usually triggers it — procurement, the client's legal team, or something else?" Demand-origin Q — identifies who initiates the requirement. | Await reply | 2026-07-06 | MEDIUM | waiting |
...
| B125 | Tim Deussen | XRBB - Extended Reality Berlin-Brandenburg | partner/advisor | Call Taken | 2026-06-24 | Jun 6: corrected Art. 50 framing. Jun 8: advisory call ask sent. Jun 24: 25-min Zoom call (late start after initial no-show). Key outputs: (1) validated gap — "no company for front-to-back rights management in generative workflows — that is the opportunity"; (2) confirmed two-layer split: Art. 50 = labeling/disclosure (not SI8), provenance + rights management = SI8's layer; (3) C2PA is a standard to be compatible with, not a competitor; (4) recommended commercials over film near-term — "already commercially exploding"; (5) GTM advice: pilots first, integrate into AI film productions, AI festival panel talks on provenance as wedge; (6) mentioned Runway-type acquisition unprompted; (7) open to advisor/partner role — "we can see maybe there's ways of working together." Post-call analysis (Jun 24): C2PA custom assertions can embed SI8 clearance data (IP status, tools verified, likeness, commercial use auth) directly in the video file via Capture API — SI8 as judgment layer above the C2PA technical stack. Capture compliance page confirms: (a) EU Code of Practice requires multi-layer — C2PA in file + ERC-7053 on-chain hash; C2PA alone is legally insufficient; (b) Capture targets AI model providers, not agencies — the delivery-step gap SI8 fills is unaddressed by Capture; (c) Aug 2 enforcement = 39 days; (d) Capture's 10-question compliance checklist is a SI8 sales asset — most agencies will fail 5+ questions. Trust mark framing: "Cleared by SI8 · Verified by Capture." Open: confirm with Capture whether post-production re-signing satisfies 50(2). Architecture + Capture compliance findings documented in call notes. [JD personal] | **Graduated to `crm/xrbb.md` 2026-08-15.** | 2026-07-15 | MEDIUM | graduated |
...
| B130 | Ivan Petruzzelli | State Street Investment Management | buyer | Warm Lead | 2026-06-29 | "Yes we are" — confirmed State Street moving toward structured documentation; Jun 16 format probe sent. Jun 17 reply: "Yes we require a single, structured campaign brief that combines a short human summary with a machine-readable payload (spreadsheet or JSON). This ensures clarity, repeatability, and auditability across AI-driven workflows." Ambiguous — could be IP provenance documentation or campaign workflow data. [Ivy] Jun 29: DESIGN PARTNER question drafted (Ivy): "Does that governance conversation typically happen before production starts, or once there's something to review?" Pre-production vs delivery-gate timing hypothesis. | **Graduated to `crm/ivan-petruzzelli.md` 2026-09-01.** Commercial Readiness discovery follow-up drafted, not sent (Priority 1); the Jun 29 timing Q above remains a separate open thread, and the Jun 17 reply's ambiguity (IP documentation vs. general workflow data) is unresolved. | 2026-09-03 | HIGH | graduated |
...
| B148 | Myron Stapleton | R&M Geoscience Ltd | buyer | Followed Up | 2026-06-29 | "Perfect solution to this exact headache... worth its weight in gold... first person I reach out to when we start ramping up content." Founder & Executive Director, Newbury UK. Sovereign-grade infrastructure developer — UK, Caribbean, West Africa. Delivers to governments, health boards, national bodies with strict legal/procurement. Uses AI constantly for content + stakeholder materials. Jun 10: Ivy replied — acknowledged EU AI Act timing, attached Urban Drift sample, introduced JD, requested 15-20 min Zoom call. Jun 29: CONVERT message drafted (Ivy): "Still happy to set up that Zoom with JD whenever works. We've just finalized the product and it maps directly to what you described — documenting AI content for government and institutional clients. Any week work better for you?" [Ivy] | Await reply — confirm Zoom slot | 2026-07-06 | HIGH | waiting |
| B149 | Spencer Stander | STANDER PRODUCTIONS INC | buyer | Followed Up | 2026-06-29 | "Less about creative process, more about clearance — model releases, music/image rights, platforms and territories." Detailed BA-language reply to msg 1. Jun 10: Vanessa replied — mirrored clearance framing; introduced Chain of Title as equivalent of music clearance report for AI layer; quoted both tiers ($29/$499). Closed with "would this slot into your existing clearance workflow?" Jun 29: CONVERT message drafted (Vanessa): "Following up on the clearance workflow question. We've finalized the product and it's built around exactly what you described — model releases, rights, territories. Would you have 20 minutes to walk through it with JD?" [Vanessa] | Await reply | 2026-07-06 | HIGH | waiting |
...
| B155 | Nikolay Kolev | XR Future LTD | buyer | Followed Up | 2026-06-29 | "Enterprise and regulated brands: legal teams asking for AI tools used, commercial licensing confirmation, synthetic voice/face disclosure, copyright assurances, AI provenance/workflow documentation." Unprompted checklist matches SI8 product spec exactly. VR Designer, London. Jun 10: Ivy replied — confirmed checklist maps to SI8 product; sent sample link; probe on formal vs. ad hoc. Jun 29: CONVERT message drafted (Ivy): "Following up on the sample I sent. We've been refining the product based on conversations with teams like yours and have narrowed the scope considerably. Would you have 20 minutes with JD next week to see where we landed?" [Ivy] | Await reply | 2026-07-06 | HIGH | waiting |
| B156 | Bernie Su | Whispers (AI Cinema) | network | Outreach Sent | 2026-06-16 | Met JD in Taiwan Feb 2026 (SI8 v1 era). Digital/interactive storytelling creator — new project "Whispers" (AI-informed cinema, Forbes May 2026). JD's sister Alison met him at his LA AI screening event; he asked about JD. JD sent IG DM Jun 16: SI8 update (Chain of Title pivot) + E&O intro ask (line producers, EPs, entertainment attorneys). [JD personal, Instagram] | Await reply — if he replies, follow up on E&O/LP/EP intro ask; high connector value for Test 12 | 2026-06-23 | MEDIUM | waiting |
| B157 | Steve Bannerman | Prime Video & Amazon MGM Studios | buyer | Replied-Warm | 2026-06-10 | "In the feature film space, provenance of the video is HUGELY important. You will indeed see it coming up more and more." Head of Post-production, International Originals APAC + Head of International VFX. Self-excluded from ads ICP ("I don't do ads or commercials — only feature films and documentaries") but confirmed film/TV provenance signal strongly. LA-based, APAC scope. Test 12 validation. [Vanessa, SI8_Legal Friction LA] | Send Jun 17 [Vanessa]: pivot to film ICP — "That's actually helpful context — feature film provenance is a separate thread from ad campaigns, and you've confirmed it's real. Would you be open to a 15-minute compare-notes call on how APAC productions are handling this? You're one of the few people I've spoken with who's on that side of it." | 2026-06-17 | HIGH | waiting |
| B158 | Dan Lantry | Sonova Group | buyer | Replied-Warm | 2026-06-17 | VP Legal Affairs (North America), Sonova Group (hearing healthcare — Phonak, regulated medtech). Replied to NY Synthetic Performer Law outreach: "No, we aren't tracking it but would like to better understand the issue." ICP 3 signal — brand legal officer at regulated healthcare brand. If Sonova legal sets AI documentation requirements, cascades to all their agencies. [JD alias, Who's Asking / NY Law sequence] | QUEUED Jun 18 — NY Law education (advertiser liability, "actual knowledge" standard) + regulated-sector pattern observation + thesis CTA: "Does Sonova's legal team have a defined format for what you'd require from agencies producing AI content — or is that still being worked out?" No COT offer yet. | 2026-06-18 | HIGH | queued |
| B162 | Devin Curry | New York Life | buyer | Followed Up | 2026-06-28 | Senior Associate, New York Life. Replied Msg#2 of NY FinServ campaign: "I don't have any direct experience with that myself but I'm sure some colleagues have!" In-house finserv — wrong title (financial rep, not creative), right company. Referral offer implicit. [JD, SI8_RV_R4LI_CreaDir_Finserv_NY_0626A_JC] | Referral ask sent — "who handles creative / marketing for AI video compliance at New York Life?" | 2026-07-05 | LOW | referral ask sent |
| B161 | James T | Connect Management | buyer | Replied-Warm | 2026-06-17 | Head of Legal Affairs, Connect Management, London. Replied to ASA campaign (Ivy, msg 2). Talent-side legal — VFX and editing creators. "Certain AI tools are prohibited altogether... required to verify that tools used do not train on, learn from, or retain creator or client content." Data training consent angle, not Chain of Title/clearance. T2 — curious, not urgent. [Ivy, SI8_Who's Asking_ASA (4 Msg)] | QUEUED Jun 18 — probe source of "prohibited tools" requirement (client-driven or internal policy?) + what verification looks like in practice (tool provider doc vs. ToS review?) | 2026-06-18 | MEDIUM | queued |
| B159 | Todd Davidson | DNV | buyer | Not a Fit | 2026-06-17 | Director of Business Development, DNV (global risk management / energy assurance — not advertising). Replied to NY Law outreach: "Not my team personally. There are teams in other groups that maybe looking into it." Wrong industry — energy/maritime, not advertising or marketing. [JD alias, Who's Asking / NY Law sequence] | — | — | — | done |
| B160 | William Finkel | Hello Sunshine | buyer | Replied-Warm | 2026-06-29 | EVP Business & Legal Affairs, Hello Sunshine. NYC. Replied to BLA US campaign — described ICP 3 cascade mechanism verbatim: "compliance requirement will be passed down the line to agency and then production co... legal should be the last level of confirmation and responsibility." No current AI productions at HS. Said "happy to help however I can." Strongest ICP 3 signal in pipeline. [JD alias, SI8_RV_R4LI_LegalA_BLA_US_0626A_JC] Jun 29: DESIGN PARTNER question drafted (JD alias): "Who typically writes those requirements first — brand legal, procurement, or creative operations?" Requirements-origin Q — feeds ICP 3 targeting and B2B2B chain understanding. | **Graduated to `crm/william-finkel.md` 2026-09-01.** Commercial Readiness discovery follow-up drafted, not sent (Priority 2); the Jun 29 origin Q above remains a separate open thread. | 2026-09-08 | HIGH | graduated |
| P001 | Sofia Yan | Numbers Protocol (Capture) | partner | Evaluating | 2026-07-01 | In-person Taipei meeting Jul 1. Numbers confirmed infra-only; SI8's evidence package concept resonated ("SOC2 audit"). C2PA Trust List status for edited MP4 via Capture API = UNCONFIRMED. Follow-up email sent same day: technical provenance vs. commercial clearance framing, requested API docs + sandbox credentials + pricing + MP4 sample code, asked Trust List Q directly ("would signed file appear as Trust List-recognized signer in Adobe Content Authenticity, or embedded C2PA + ERC-7053 only?"). Shared meeting recording. Call notes: `03_Sales/call-notes/CALL-2026-07-01-P001-Sofia-Yan-Numbers-Protocol.md` | **Graduated to `crm/numbers-protocol.md` 2026-08-15** (merged with P002/Sherry Chung — same company). | 2026-07-07 | HIGH | graduated |
| P002 | Sherry Chung | Numbers Protocol | partner | Met In-Person | 2026-07-30 | Met at AI Wave 微醺夜 panel (Numbers/GumGum). Card says Business Developer (@sherry_numbers, sherry@numbersprotocol.io); JD believes she may also be a co-founder and technical lead — unconfirmed, worth clarifying directly rather than assuming. JD spoke with her after the panel about partnering on more technical features (C2PA/Capture integration side, distinct from the commercial-partnership conversation with Sofia) — no audio recording of this conversation exists. | **Graduated to `crm/numbers-protocol.md` 2026-08-15** (merged with P001/Sofia Yan — same company). Role clarification still open — do that directly with Sherry. | — | MEDIUM | graduated |
| B163 | Jeffrey Chen (陳宇春) | Kneron (Taiwan) Co., Ltd. | buyer | Followed Up | 2026-08-06 | Met at AI Wave 微醺夜 panel (Numbers/GumGum), card exchanged. Assistant VP Product Marketing (產品行銷助理副總裁), Kneron (Taiwan) — AI chip / edge-AI company. Asked a detailed Open Mic Q&A question: is an AI-generated ad exposed to risk when the script is AI-written even though the likeness/voice used are properly licensed (described as a client's situation)? JD answered live on stage: AI output itself has no copyright; the commercial concept/execution can be trademarked separately; an AI-assisted script can gain copyright if a human substantively edits it ("there has to be human input in the middle"); flagged SI8's own review focus on AI content resembling existing IP or likeness. Full exchange: `03_Sales/transcripts/numbers-gumgum-panel-073026-transcript.txt`, ~[52:00]-[54:48]. Aug 6: JD sent bilingual (ZH/EN) follow-up email to jeffrey-yc.chen@kneron.us — referenced his exact Q&A question directly, asked about the related project he mentioned Kneron is working on, proposed a 30-min call in the next 1-2 weeks. | Await reply; if he confirms a call, capture what Kneron's project actually is before the call — currently unknown beyond "related project" mentioned verbally at the panel | 2026-08-20 | HIGH | waiting |
| B164 | Alice Feng (馮鈺婷) | Anchor Film (錨點影音股份有限公司) | partner | Strategic Partner Discovery | 2026-07-30 | Met at AI Wave 微醺夜 panel; unrecorded post-panel conversation notes now logged. Co-founder, Anchor Film — established Taiwan AI video production company (real clients incl. Sinyi Realty, CTBC Investments; multiple 2025 government AI R&D grants). Alice described a real pain point matching SI8's thesis (Taiwan enterprise clients hesitant to approve AI ads over commercial-safety uncertainty) and self-disclosed a genuine evidence gap (Anchor has had to "recreate" prompts/logs after the fact on past projects — she recognizes reconstructed prompts aren't reliable provenance, unprompted alignment with SI8's Domain H corroboration rule). Her "AI Creation Dossier Platform" concept (deck pp.24-25, names Numbers Protocol as intended provenance partner) originated from seeing "Liquid Engine" at NAB — a specific, checkable origin story that adds credibility to her direct claim that it's grant-proposal stage, not yet built (deck text itself doesn't confirm this either way — see full verification trail in call notes). Alice's own framing: complementary, not competitive — Anchor captures first-party production evidence, SI8 provides independent third-party assessment on top. Offered: Taiwan referrals, speaking invitations to Taiwan panels/associations, and potential inclusion of paid SI8 assessments in her grant budget as an external consultant/provider. Full notes: `03_Sales/call-notes/CALL-2026-07-30-B164-Alice-Feng-Anchor-Film.md`. Aug 1-2: conversation incorporated into SI8's Living Notebook (`06_Operations/institutional-knowledge/notebook/`) — cited as source evidence for POS-001 (Domain H corroboration rule, independently confirmed by Alice's own reconstructed-prompts admission) and POS-005 (evidence-capture vs. independent-assessment complementary framing); the grant-funded-engagement possibility she raised is logged as open question PQ-006 (conflict-of-interest disclosure scope), to be resolved before any paid engagement is structured this way. Aug 13: Alice's separate public open-mic remarks from the same panel now logged in full (a complete-session professional recording surfaced and was transcribed) — she independently cited a real Taiwan copyright case (蔡阿嘎's wife) turning on complete-creative-record evidence, disclosed that named enterprise clients (Chunghwa Telecom, Taiwan Mobile) already issue her team a prompt self-check list, detailed 3 design requirements for her creation-dossier system, and raised a Taiwan-specific "mainland-capital tool" screening requirement for public-sector clients not previously captured anywhere in SI8's research. Both follow-ups actioned same day: POS-001's evidence trail extended with the new corroboration, and the public-sector tool-sourcing angle logged as PQ-007 (open). | **Graduated to `crm/anchor-film.md` 2026-08-15.** Aug 21: ~91-min follow-up call (recorded/transcribed/translated) — Alice's creation-record prototype remains pre-product/grant-seeking; live-demoed SI8's CRC concept, well received; new grant-mechanics detail (capital-capped subsidy, foreign-entity ineligibility); Alice offered Sept-grant budget inclusion + intros (AI film director, 2 investor contacts). Next action: confirm Sept 3-4 Living Lab event attendance (see `crm/anchor-film.md` for full detail + ChatGPT strategic analysis). | 2026-09-03 | HIGH | graduated |
| B165 | Aaron Chen (陳沐民) | Harbor Angel (北灣天使資本股份有限公司) | investor | Met In-Person | 2026-07-30 | Met at AI Wave 微醺夜 panel, card exchanged. Strategic Investment Partner (戰略投資合夥人), Harbor Angel (angel investment fund, Taipei). No specific SI8 conversation content on file yet. | JD to confirm whether any SI8-specific discussion happened beyond the card exchange; otherwise treat as a general networking contact, not an active lead | — | LOW | — |
...
| B166 | Damien Barron-Tan (+ Matthew Crescenzo, matthew.crescenzo — new name, role/company unconfirmed, CC'd on the Aug 8 pre-call email, presumed Carbon colleague joining the call, not yet verified) | Carbon (independent creative/production agency, HK-headquartered + Singapore office; carbonmoves.com is the site domain, not the company name) — CEO, founded the agency (2004 or 2005, sources differ, ~34 employees per Tracxn May 2026) | buyer | Call Scheduled | 2026-08-08 | Booked Calendly directly — "SuperImmersive 8 - Commercial Assurance for AI Video" event type, no prior outreach campaign on file. Booking note field reads "please use this time slot for a networking & learning call" signed JD — phrasing suggests this may be a warm/personal contact rather than a cold inbound booking, not yet confirmed either way. JD-supplied background (Tencent/HKEX/Hyatt/HYROX as clients, UK office, public AI-workflow commentary) could **not** be independently corroborated via search as of Aug 8 prep pass — treat as unconfirmed, not repeat as fact on the call. Full discovery brief: `03_Sales/call-notes/PREP-2026-08-13-B166-Damien-Barron-Tan-Carbon.md`. Aug 8: JD sent pre-call warm-up email to damien.barrontan + matthew.crescenzo — complimented Carbon's creative-strategy/APAC work (still Damien-only research, unverified per above), asked about their AI workflows and what prompted the booking, framed as a two-way conversation not a pitch. | **Graduated to `crm/carbon.md` 2026-08-15** — Aug 13 call confirmed did NOT happen, still meeting_scheduled, needs a real reschedule date. | 2026-08-13 | HIGH | graduated |
...
| B167 | Patrick Lee | Fanverse (Co-Founder & CEO); Co-Founder, Rotten Tomatoes; also listed as VENN co-founder in Sept 2026 speaker bio | partner | Strategic Partner Discovery | 2026-09-01 | Existing personal relationship — JD attended a private Taipei screening Patrick hosted (Feb 3, 2025, "Café by the Highway," Eslite Art House). Sep 1: JD sent re-engagement email referencing Patrick's StartSphere Taipei panel this week ("How Technology is Transforming Entertainment," entertainment-tech investment summit) — JD can't attend the panel — introducing SI8 + CRC (Commercial Assurance infrastructure for AI video: tool terms, copyright/rights, provenance, commercial-use risk), noting production-company conversations pointing toward this becoming infrastructure between AI production workflow and the brand/studio/distributor that approves the content. Asked if he's in Taipei a while longer for coffee (30-45 min) or Zoom. Angle: AI film/video + Commercial Assurance — partnership/investment BD lead, not a Gear A/B/C sales lead. Possible overlap with a "Patrick Lee" Alice Feng (Anchor Film) separately named as an investor-intro contact (Aug 21 call notes) — not yet confirmed as the same person. | **Graduated to `crm/patrick-lee.md` 2026-09-01.** Await reply to Sept 1 email. | 2026-09-15 | MEDIUM | graduated |
<!-- pipeline:end -->
