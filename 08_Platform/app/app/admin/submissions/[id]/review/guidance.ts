...
If it helps to ask directly (illustrative only, not a script): Is this delivery the only planned use, or do they expect to reuse any part of it? Do they expect to own, control, or have exclusive use of any element created here? Could anything become a recurring brand or campaign asset? Do they expect to adapt, license, or otherwise exploit this beyond the stated delivery? Record their stated expectation accurately — these questions elicit their expectation, they don't establish that any ownership or exclusivity actually exists.`,
