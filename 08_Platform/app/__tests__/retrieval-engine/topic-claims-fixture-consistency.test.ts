...
describe('GOVERNED-CLAIMS.md <-> topic-claims-fixture.ts consistency', () => {
  ...
  test('exactly thirty-three claims in the runtime fixture are Adopted + CRC-eligible as of 2026-09-16 -- the prior thirty-two (see prior version of this test/GOVERNED-CLAIMS.md for full provenance) plus CLAIM-TRADEMARK-US-LANHAM-CONFUSION-001-v1, activated via the Trademark CRC Production Representation milestone -- the first trademark-topic claim to reach real CRC eligibility, and the first claim whose sole applicability_requirements gate is jurisdiction equals United States (federal). CRC Approver: JD (PM), CRC Decision Date: 2026-09-16. The sibling CLAIM-LIKENESS-NY-CONSENT-REQUIREMENT-001-v1 remains correctly absent (WITHHELD under CPR_008, unaffected by this activation) -- see CLAIMS_WITHOUT_FIXTURE_REPRESENTATION above, unchanged. CLAIM-MUSIC-ARTLIST-AI-TRAINING-EXCLUSION-001-v1 remains correctly absent (WITHHELD, unaffected). The now-Deprecated CLAIM-PIKA-COMMERCIAL-USE-PAID-PLAN-001-v1 remains correctly absent -- update only when a further real decision is recorded', () => {
