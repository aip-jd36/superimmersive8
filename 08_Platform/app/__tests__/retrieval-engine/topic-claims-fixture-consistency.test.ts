...
describe('GOVERNED-CLAIMS.md <-> topic-claims-fixture.ts consistency', () => {
  ...
  test('exactly thirty-five claims in the runtime fixture are Adopted + CRC-eligible as of 2026-09-21 -- the prior thirty-four (see prior version of this test/GOVERNED-CLAIMS.md for full provenance) plus CLAIM-COPYRIGHT-TW-AI-ASSISTED-OUTPUT-001-v1, activated via the Taiwan AI-Assisted Copyrightability CRC Production Representation milestone -- the first Taiwan-jurisdiction claim in this corpus to reach real CRC eligibility, reusing the existing copyrightability topic and the existing human_contribution_description dependency (D1, the same dependency already carried by CLAIM-COPY-001/002/003-v1). CRC Approver: JD (PM), CRC Decision Date: 2026-09-21. All prior claims remain unchanged -- update only when a further real decision is recorded', () => {
