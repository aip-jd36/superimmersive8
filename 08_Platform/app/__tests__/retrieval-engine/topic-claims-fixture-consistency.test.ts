...
describe('GOVERNED-CLAIMS.md <-> topic-claims-fixture.ts consistency', () => {
  ...
  test('exactly thirty-four claims in the runtime fixture are Adopted + CRC-eligible as of 2026-09-19 -- the prior thirty-three (see prior version of this test/GOVERNED-CLAIMS.md for full provenance) plus CLAIM-COPYRIGHT-US-THIRD-PARTY-OUTPUT-001-v1, activated via the Third-Party Copyright CRC Production Representation milestone -- the first third_party_copyright-topic claim to reach real CRC eligibility, and the second claim (after Trademark) whose sole applicability_requirements gate is jurisdiction equals United States (federal), and the first claim with zero unresolved_project_dependencies to be a sibling of a same-shaped one-dependency claim (Trademark). CRC Approver: JD (PM), CRC Decision Date: 2026-09-19. The sibling CLAIM-LIKENESS-NY-CONSENT-REQUIREMENT-001-v1 remains correctly absent (WITHHELD under CPR_008, unaffected by this activation) -- see CLAIMS_WITHOUT_FIXTURE_REPRESENTATION above, unchanged. CLAIM-MUSIC-ARTLIST-AI-TRAINING-EXCLUSION-001-v1 remains correctly absent (WITHHELD, unaffected). The now-Deprecated CLAIM-PIKA-COMMERCIAL-USE-PAID-PLAN-001-v1 remains correctly absent -- update only when a further real decision is recorded', () => {
    const liveClaims = TOPIC_CLAIMS_FIXTURE.filter((c) => c.lifecycle === 'Adopted' && c.crc_eligible === 'Yes')
    expect(liveClaims.map((c) => c.claim_id).sort()).toEqual(['CLAIM-ADOBESTOCK-AI-STUDIO-COMMERCIALLY-SAFE-LABEL-001-v1', 'CLAIM-COPY-001-v1', 'CLAIM-COPY-002-v1', 'CLAIM-COPY-003-v1', 'CLAIM-COPY-004-v1', 'CLAIM-COPYRIGHT-US-THIRD-PARTY-OUTPUT-001-v1', 'CLAIM-EUAI-ART50-4-AUDIOVISUAL-DEEPFAKE-DISCLOSURE-001-v1', 'CLAIM-KLING-COMMERCIAL-USE-BASELINE-001-v1', 'CLAIM-KLING-COMMERCIAL-USE-MEMBER-001-v1', 'CLAIM-MUSIC-ARTLIST-CLIENT-LICENSE-RETENTION-001-v1', 'CLAIM-MUSIC-ARTLIST-ENTERPRISE-THRESHOLD-001-v1', 'CLAIM-MUSIC-ARTLIST-PRO-ROYALTIES-001-v1', 'CLAIM-MUSIC-ARTLIST-PROJECT-LICENSE-DURATION-001-v1', 'CLAIM-MUSIC-ARTLIST-SOCIAL-VS-PRO-001-v1', 'CLAIM-MUSIC-ARTLIST-STANDALONE-EXPLOITATION-001-v1', 'CLAIM-MUSIC-ENVATO-CANCELLATION-001-v1', 'CLAIM-MUSIC-ENVATO-SYNC-001-v1', 'CLAIM-MUSIC-EPIDEMIC-TIER-ADVERTISING-001-v1', 'CLAIM-NY-SYNTHETIC-PERFORMER-DISCLOSURE-001-v1', 'CLAIM-PIKA-COMMERCIAL-USE-BASELINE-001-v1', 'CLAIM-PIKA-COMMERCIAL-USE-PAID-PLAN-FANCY-001-v1', 'CLAIM-PIKA-COMMERCIAL-USE-PAID-PLAN-PRO-001-v1', 'CLAIM-PIKA-COMMERCIAL-USE-PAID-PLAN-STANDARD-001-v1', 'CLAIM-POND5-EDITORIAL-COMMERCIAL-USE-CONSENT-001-v1', 'CLAIM-RUNWAY-COMMERCIAL-USE-001-v1', 'CLAIM-STABILITYAI-COMMERCIAL-USE-001-v1', 'CLAIM-STOCK-EDITORIAL-001-v2', 'CLAIM-STOCK-EDITORIAL-002-v2', 'CLAIM-STOCK-GETTY-EDITORIAL-001-v1', 'CLAIM-STOCK-ISTOCK-EDITORIAL-001-v1', 'CLAIM-STOCK-SHUTTERSTOCK-EDITORIAL-001-v1', 'CLAIM-STORYBLOCKS-BUSINESS-LICENSE-BROADCAST-001-v1', 'CLAIM-SYNTHESIA-STOCK-PAID-PROMOTION-001-v1', 'CLAIM-TRADEMARK-US-LANHAM-CONFUSION-001-v1'])
  })
