...
describe('GOVERNED-CLAIMS.md <-> topic-claims-fixture.ts consistency', () => {
  ...
  test('exactly sixteen claims in the runtime fixture are Adopted + CRC-eligible as of 2026-09-02 -- the prior fourteen (see prior versions of this test/GOVERNED-CLAIMS.md for their own individual provenance, most recently CLAIM-ADOBESTOCK-AI-STUDIO-COMMERCIALLY-SAFE-LABEL-001-v1) plus the fifteenth and sixteenth: CLAIM-KLING-COMMERCIAL-USE-BASELINE-001-v1 and CLAIM-KLING-COMMERCIAL-USE-MEMBER-001-v1 (the first two-claim, tool_scope-narrowed publication in this fixture, and the first published claim_character: conditional claim), CRC Publication approved 2026-09-02 (CRC Approver: JD (PM)) following CPR_015 -- a post-retirement reconsideration superseding CPR_013/CPR_014\'s prior WITHHOLD, after the corresponding legacy PLATFORM-RIGHTS-MATRIX.md Kling rows were executed-retired (crc_eligible: No) and confirmed live in Production, empirically re-confirmed by CPR_015\'s own addendum. The 9 Music Scenario A claims remain WITHHELD/PENDING and are correctly absent from this list -- update only when a further real decision is recorded', () => {
