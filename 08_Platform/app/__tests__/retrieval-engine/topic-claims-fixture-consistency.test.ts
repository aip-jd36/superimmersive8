...
describe('GOVERNED-CLAIMS.md <-> topic-claims-fixture.ts consistency', () => {
  ...
  test('exactly thirty-one claims in the runtime fixture are Adopted + CRC-eligible as of 2026-09-10 -- the prior thirty (see prior version of this test/GOVERNED-CLAIMS.md for full provenance) plus CLAIM-NY-SYNTHETIC-PERFORMER-DISCLOSURE-001-v1, activated via CPR_025 (Generic Non-Provider TopicClaim Runtime Activation milestone) -- the first likeness-topic claim, and the second provider_scope: null / tool_scope: null claim after the four CLAIM-COPY-* entries, to reach real runtime representation. CRC Approver: JD (PM), CRC Decision Date: 2026-09-10. The sibling CLAIM-LIKENESS-NY-CONSENT-REQUIREMENT-001-v1 remains correctly absent (WITHHELD under CPR_008, unaffected by this activation) -- see CLAIMS_WITHOUT_FIXTURE_REPRESENTATION above, unchanged. CLAIM-MUSIC-ARTLIST-AI-TRAINING-EXCLUSION-001-v1 remains correctly absent (WITHHELD, unaffected). The now-Deprecated CLAIM-PIKA-COMMERCIAL-USE-PAID-PLAN-001-v1 remains correctly absent -- update only when a further real decision is recorded', () => {
