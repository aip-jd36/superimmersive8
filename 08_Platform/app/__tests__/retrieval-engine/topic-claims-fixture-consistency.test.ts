...
describe('GOVERNED-CLAIMS.md <-> topic-claims-fixture.ts consistency', () => {
  ...
  test('exactly fourteen claims in the runtime fixture are Adopted + CRC-eligible as of 2026-08-31 -- the prior thirteen (CLAIM-COPY-004-v1, CLAIM-STOCK-EDITORIAL-001-v2/-002-v2, CLAIM-STOCK-GETTY/ISTOCK/SHUTTERSTOCK-EDITORIAL-001-v1, CLAIM-COPY-001-v1/-002-v1/-003-v1, CLAIM-MUSIC-ARTLIST-PROJECT-LICENSE-DURATION-001-v1, CLAIM-SYNTHESIA-STOCK-PAID-PROMOTION-001-v1, CLAIM-STORYBLOCKS-BUSINESS-LICENSE-BROADCAST-001-v1, CLAIM-POND5-EDITORIAL-COMMERCIAL-USE-CONSENT-001-v1 -- see prior versions of this test/GOVERNED-CLAIMS.md for their own individual provenance) plus the fourteenth and newest: CLAIM-ADOBESTOCK-AI-STUDIO-COMMERCIALLY-SAFE-LABEL-001-v1, the fourth real provider_scope-narrowed claim (after A-3, Storyblocks, Pond5) and the first claim in this fixture with unresolved_project_dependencies: [] from Adoption, CRC Publication approved 2026-08-31 (CRC Approver: JD (PM)) following CPR_012 with no intervening DEFER -- Trial 4 of the Living Knowledge onboarding benchmark, the first trial run under the LK-68/LK-68A prospective benchmark instrumentation. The other 9 Music Scenario A claims remain WITHHELD/PENDING and are correctly absent from this list -- update only when a further real decision is recorded', () => {
    const liveClaims = TOPIC_CLAIMS_FIXTURE.filter((c) => c.lifecycle === 'Adopted' && c.crc_eligible === 'Yes')
    expect(liveClaims.map((c) => c.claim_id).sort()).toEqual(['CLAIM-ADOBESTOCK-AI-STUDIO-COMMERCIALLY-SAFE-LABEL-001-v1', 'CLAIM-COPY-001-v1', 'CLAIM-COPY-002-v1', 'CLAIM-COPY-003-v1', 'CLAIM-COPY-004-v1', 'CLAIM-MUSIC-ARTLIST-PROJECT-LICENSE-DURATION-001-v1', 'CLAIM-POND5-EDITORIAL-COMMERCIAL-USE-CONSENT-001-v1', 'CLAIM-STOCK-EDITORIAL-001-v2', 'CLAIM-STOCK-EDITORIAL-002-v2', 'CLAIM-STOCK-GETTY-EDITORIAL-001-v1', 'CLAIM-STOCK-ISTOCK-EDITORIAL-001-v1', 'CLAIM-STOCK-SHUTTERSTOCK-EDITORIAL-001-v1', 'CLAIM-STORYBLOCKS-BUSINESS-LICENSE-BROADCAST-001-v1', 'CLAIM-SYNTHESIA-STOCK-PAID-PROMOTION-001-v1'])
  })
})
