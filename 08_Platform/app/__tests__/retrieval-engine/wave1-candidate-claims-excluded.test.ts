...
describe('Wave 1 real claims -- governance state as of 2026-08-19 (all four COPY claims + REL-COPY now CRC-eligible)', () => {
   ...
   *
   * Updated again 2026-08-31 (LK-75, Trial 4 -- Fourth Real Provider-Scoped
   * TopicClaim Runtime Mirroring): CLAIM-ADOBESTOCK-AI-STUDIO-COMMERCIALLY-
   * SAFE-LABEL-001-v1 gained its first real runtime fixture entry, following
   * explicit human CRC Publication approval (CPR_012, no intervening
   * DEFER). Count grows from fifteen to sixteen. First claim in this
   * fixture with unresolved_project_dependencies: [] from Adoption -- a
   * deliberate FGR-stage design, empirically stress-tested at CPR_012, not
   ...
   *
   * Updated again 2026-09-16 (Trademark CRC Production Representation
   * milestone): CLAIM-TRADEMARK-US-LANHAM-CONFUSION-001-v1 gained its first
   * real runtime fixture entry -- the first `topic: 'trademark'` entry in
   * this fixture. Count grows from thirty-three to thirty-four. This one
   * IS `crc_eligible: 'Yes'` (CPR_027) -- its own reachability/applicability/
   * BI behavior is proven separately by a dedicated trademark test file.
   *
   * Updated again 2026-09-19 (Third-Party Copyright CRC Production
   * Representation milestone): CLAIM-COPYRIGHT-US-THIRD-PARTY-OUTPUT-001-v1
   * gained its first real runtime fixture entry -- the first
   * `topic: 'third_party_copyright'` entry in this fixture. Count grows
   * from thirty-four to thirty-five. This one IS `crc_eligible: 'Yes'`
