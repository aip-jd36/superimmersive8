    ...
    const denseParsedCandidates = [
      {
        ...
        raw_jurisdiction_value: null,
        is_jurisdiction_exclusion: false,
        raw_content_presence_category: null,
        is_content_presence_absent: false,
        raw_territory_value: null,
        raw_organization_location_value: null,
