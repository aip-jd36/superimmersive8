...
export const MATRIX_FIXTURE: MatrixRow[] = [
  ...
  },
  {
    ...
    last_verified: '2026-08-05',
    claims: [
      { claim_id: 'google-veo', crc_eligible: 'Pending', crc_publication_scope: null, crc_candidate_statement: null },
    ],
  },
  {
    ...
    last_verified: '2026-08-05',
    claims: [
      { claim_id: 'adobe-firefly', crc_eligible: 'Pending', crc_publication_scope: null, crc_candidate_statement: null },
    ],
  },
  {
    ...
    claims: [
      { claim_id: 'openai-sora', crc_eligible: 'Pending', crc_publication_scope: null, crc_candidate_statement: null },
    ],
  },
  {
    ...
    last_verified: '2026-08-05',
    claims: [
      { claim_id: 'gemini-api', crc_eligible: 'Pending', crc_publication_scope: null, crc_candidate_statement: null },
    ],
  },
  {
    ...
    last_verified: '2026-08-06',
    claims: [
      { claim_id: 'gemini-consumer-app', crc_eligible: 'Pending', crc_publication_scope: null, crc_candidate_statement: null },
    ],
  },
  {
