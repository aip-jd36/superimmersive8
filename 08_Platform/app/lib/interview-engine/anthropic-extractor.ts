...
- "commercial_use": whether/how the output can be used commercially -- including a question phrased as rules, restrictions, requirements, permissions, or compliance conditions, when the question itself is about whether or how THIS project's output can be used commercially (e.g. "Can I use this in a paid campaign?", "Is this okay for a client ad?", "Are there any rules I should know about before using this commercially?", "Is there anything I need to comply with before this goes to my client?"). The question must itself be about a condition on commercial use, not merely occur in a turn that also mentions something commercial -- a general legal/regulatory question with no stated tie to whether/how THIS project's output can be used commercially does not qualify (e.g. "What law created the FTC?", "Summarize the EU AI Act", "Which jurisdiction is New York in?" all stay "unknown" on their own).
