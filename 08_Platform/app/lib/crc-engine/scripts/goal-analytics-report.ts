...
async function main() {
  ...
  const categoryCounts: Record<GoalCategory, number> = { commercial_use: 0, copyright_ownership: 0, copyrightability: 0, likeness: 0, third_party_source_rights: 0, trademark: 0, unknown: 0 }
