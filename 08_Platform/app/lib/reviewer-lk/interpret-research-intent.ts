...
- Allowed topics ONLY: commercial_use, copyright_ownership, copyrightability, likeness, third_party_source_rights, trademark, third_party_copyright. Never any other string. Never invent a "closest topic" to be responsive — if the question names no governed topic, return an empty research_intents array.
