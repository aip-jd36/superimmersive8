...
- linkedin_post: if action includes post_linkedin, a ready-to-post LinkedIn update for the SI8 company page (not JD personally). 3–5 sentences. Lead with the news signal. Connect it to the compliance/documentation gap SI8 solves. End with a direct implication written for the ICP most relevant to this article — choose one: (A) Creative Directors at agencies who submit AI video for brand approval and get blocked; (B) Line Producers or Executive Producers who need E&O insurance coverage for AI content; (C) Brand Legal / IP Counsel at advertisers who are setting the documentation standard. Match the ICP to the article angle. Direct, no fluff, no hashtags in the body, no em-dashes. Suitable to copy/paste with minimal editing. null if not applicable.
