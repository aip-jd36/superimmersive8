...
Gated downloads used to capture email subscribers.
...
`[slug]/` → contains source `.md`, exported `.pdf`, and any design assets

## Naming Convention
`[audience]-[title-slug]-v[X].pdf`
Example: `brands-ai-video-rights-guide-v1.pdf`
